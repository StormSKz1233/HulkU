...
local Window = create:Win("H U L K  U | H U B : B L O X  F R U I T S")
local Tap1 = Window:Taps("Auto Farm")
local Tap2 = Window:Taps("Stats & Status")
local Tap3 = Window:Taps("Teleport")
local Tap99 = Window:Taps("Devil Fruits")
local Tap4 = Window:Taps("BuyItem")
local Tap5 = Window:Taps("Raid")
local Tap6 = Window:Taps("Players")
local Tap7 = Window:Taps("Misc")
...
local pagedf1 = Tap99:newpage()
local pagedf2 = Tap99:newpage()
local page7 = Tap4:newpage()
local page8 = Tap4:newpage()
local page9 = Tap5:newpage()
local page10 = Tap5:newpage()
local page111 = Tap6:newpage()
local page122 = Tap6:newpage()
